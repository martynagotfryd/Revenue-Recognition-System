    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "1", "abc", "Windows" });

            migrationBuilder.InsertData(
                table: "software_version",
                columns: new[] { "Id", "SoftwareId", "Version" },
                values: new object[] { 1, null, "10a" });

            migrationBuilder.InsertData(
                table: "contract",
                columns: new[] { "Id", "End", "IdClient", "IdSoftwareVersion", "Price", "Signed", "Start" },
                values: new object[] { 1, new DateTime(2024, 6, 25, 13, 16, 8, 961, DateTimeKind.Local).AddTicks(919), 1, 1, 200.0, true, new DateTime(2024, 6, 25, 13, 16, 8, 961, DateTimeKind.Local).AddTicks(912) });

            migrationBuilder.InsertData(
                table: "discount",
                columns: new[] { "Id", "End", "IdSoftware", "Name", "Start", "Value" },
                values: new object[] { 1, new DateTime(2024, 6, 25, 13, 16, 8, 961, DateTimeKind.Local).AddTicks(846), 1, "this", new DateTime(2024, 6, 25, 13, 16, 8, 961, DateTimeKind.Local).AddTicks(782), 200.0 });
