...
namespace project.Migrations
{
    ...
    [Migration("20240628145519_Init2")]
    partial class Init2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("project.Models.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("UpgradesEnd")
                        .HasColumnType("datetime2");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            End = new DateTime(2024, 6, 28, 16, 55, 18, 497, DateTimeKind.Local).AddTicks(9498),
                            IdClient = 1,
                            IdSoftwareVersion = 1,
                            Price = 200.0,
                            Signed = true,
                            Start = new DateTime(2024, 6, 28, 16, 55, 18, 497, DateTimeKind.Local).AddTicks(9487),
                            UpgradesEnd = new DateTime(2025, 6, 28, 16, 55, 18, 497, DateTimeKind.Local).AddTicks(9505)
                        });
                });
            ...
            modelBuilder.Entity("project.Models.Discount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            End = new DateTime(2024, 6, 28, 16, 55, 18, 497, DateTimeKind.Local).AddTicks(9383),
                            IdSoftware = 1,
                            Name = "this",
                            Start = new DateTime(2024, 6, 28, 16, 55, 18, 497, DateTimeKind.Local).AddTicks(9307),
                            Value = 200.0
                        });
                });
